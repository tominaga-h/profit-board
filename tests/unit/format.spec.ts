...
describe('formatYen', () => {
  ...
  it('小数は四捨五入して整数にする', () => {
    // DB は NUMERIC(12,0) なので本来小数は来ないが、実績入力画面の未保存フォーム値が
