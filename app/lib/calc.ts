 ...
 *   実際の入力範囲（work_hours は NUMERIC(6,2)）の 0.00〜400.00h を
 *   0.01 刻みで数えると 2,400 件が期待と食い違う（Math.round 方式でも 286 件）。
 *
 ...
 * 利益率（粗利率）を % で返す。
 *
 * ★ 売上0のときは0を返す。仕様が「売上ゼロの場合は0%」と明示している。
 ...
 *   これが仕様通りの挙動。
 *
 * ★ ここでは丸めない。仕様に率の丸め桁の定義がなく、DBにも保存しない
